...
% しかし、危険な処理を避けるために、ユーザがownershipの受け渡しが正しく行われているかを確認する必要があり、
% 不便である。
...
\subsection{lifetime}
% borrowingを自動で返すため　lifetimeは自動で推論
